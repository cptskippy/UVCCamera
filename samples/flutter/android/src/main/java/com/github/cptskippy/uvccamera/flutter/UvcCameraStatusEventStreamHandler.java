...
/**
 * Handle the per-camera "uvccamera/camera@<cameraId>/status_events" event channel.
 *
 * Stores the event sink while the Dart side is listening so the platform can cast status events. The sink

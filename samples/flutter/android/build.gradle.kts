...
android {
    namespace = "com.github.cptskippy.uvccamera.flutter"
    compileSdk = 34
...
dependencies {
    ...
    implementation("com.github.cptskippy.uvccamera:lib:$version") // NOTE: Use com.github.cptskippy.uvccamera:lib of the same version as the plugin.

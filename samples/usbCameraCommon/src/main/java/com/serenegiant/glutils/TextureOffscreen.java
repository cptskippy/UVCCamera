...
public class TextureOffscreen {
	 ...
	 *     use_depth_buffer: set true if you use depth buffer. the depth is fixed as 16bits.
	 */
	public TextureOffscreen(final int width, final int height,
	 ...
	 *     width: The width value in pixels.
	 *     height: The height value in pixels.
	 *     use_depth_buffer: The use depth buffer value.
	 */
	public TextureOffscreen(final int tex_unit,
	 ...
	 *     height: The height value in pixels.
	 *     use_depth_buffer: The use depth buffer value.
	 *     adjust_power2: The adjust power2 value.
	 */
	public TextureOffscreen(final int width, final int height,
	 ...
	 *
	 * Args:
	 *     tex_target: The tex target value.
	 *     tex_unit: The tex unit value.
	 *     tex_width: The tex width value.
	 *     tex_height: The tex height value.
	 *
	 * Returns:
	 *     The gen texture.
	 */
